...
from transformers.models.olmo2.modeling_olmo2 import Olmo2Attention, Olmo2Config, Cache, repeat_kv, apply_rotary_pos_emb
import transformers.models.olmo2.modeling_olmo2 as modeling_olmo2
from monkey_patch_head_types import *

# From: transformers/models/olmo2/modeling_olmo2.py
...
class MyOlmo2Attention(Olmo2Attention):
...
def patch_olmo2(save_value_states=False, 
                save_pre_output_proj_hidden_states=False, 
                save_post_output_proj_hidden_states=False,
                track_head_type=None,
                zero_track_head_type=False,
                record_head_scores=False,
                layers_to_exclude=[]):
    class PatchedOlmo2Attention(MyOlmo2Attention):
        def __init__(self, config: Olmo2Config, layer_idx: Optional[int] = None, *args, **kwargs):
    ...
    modeling_olmo2.Olmo2Attention = PatchedOlmo2Attention
