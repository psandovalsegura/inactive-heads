...
from transformers.models.qwen2.modeling_qwen2 import Qwen2Attention, Qwen2Config, Unpack, FlashAttentionKwargs, Cache, repeat_kv, apply_rotary_pos_emb
...
class MyQwen2Attention(Qwen2Attention):
...
def patch_qwen2(save_value_states=False, 
                save_pre_output_proj_hidden_states=False, 
                save_post_output_proj_hidden_states=False,
                track_head_type=None,
                zero_track_head_type=False,
                record_head_scores=False,
                layers_to_exclude=[]):
    class PatchedQwen2Attention(MyQwen2Attention):
        def __init__(self, config: Qwen2Config, layer_idx: Optional[int] = None, *args, **kwargs):
    ...
    modeling_qwen2.Qwen2Attention = PatchedQwen2Attention
